...
ol.proj.get("EPSG:3031").setExtent([-2734967.269074, -2711979.365452, 2894496.168842, 2473052.748417]);
var wms_layers = [];
...
lyr_AWSSite_2.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'Repo Link': 'Repo Link', 'Region': 'Region', 'Elevation': 'Elevation', 'Lat/Long': 'Lat/Long', });
...
lyr_AWSSite_2.set('fieldImages', {'fid': 'Hidden', 'Name': 'TextEdit', 'Repo Link': 'TextEdit', 'Region': 'TextEdit', 'Elevation': 'TextEdit', 'Lat/Long': 'TextEdit', });
...
lyr_AWSSite_2.set('fieldLabels', {'Name': 'inline label', 'Repo Link': 'inline label', 'Region': 'inline label', 'Elevation': 'inline label', 'Lat/Long': 'inline label', });
