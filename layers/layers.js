...
ol.proj.get("EPSG:3031").setExtent([-2734967.269074, -2568055.846282, 2878909.410609, 2473052.748417]);
var wms_layers = [];
...
lyr_AutomaticWeatherStation_2.set('fieldAliases', {'Name': 'Name', 'Repo Link': 'Repo Link', 'Region': 'Region', 'Elevation': 'Elevation', 'Lat/Long': 'Lat/Long', 'x': 'x', 'y': 'y', });
...
lyr_AutomaticWeatherStation_2.set('fieldImages', {'Name': 'TextEdit', 'Repo Link': 'TextEdit', 'Region': 'TextEdit', 'Elevation': 'TextEdit', 'Lat/Long': 'TextEdit', 'x': 'TextEdit', 'y': 'TextEdit', });
...
lyr_AutomaticWeatherStation_2.set('fieldLabels', {'Name': 'inline label', 'Repo Link': 'inline label', 'Region': 'inline label', 'Elevation': 'inline label', 'Lat/Long': 'inline label', 'x': 'no label', 'y': 'no label', });
lyr_ResearchStation_3.set('fieldLabels', {'id': 'no label', 'Name': 'inline label', 'Link': 'inline label', });
