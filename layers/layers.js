...
lyr_AutomaticWeatherStation_2.set('fieldLabels', {'Station': 'inline label', 'Repo Link': 'inline label', 'AWS Home': 'inline label', 'Lat/Long': 'inline label', 'Elevation': 'inline label', });
