...
function exp_Antarcticbasemap_0rule0_eval_expression(context) {
    // surface = 'ice shelf' OR surface = 'rumple' OR surface = 'ocean' OR surface = 'ice tongue'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((feature.get('surface')  == 'ice shelf') || (feature.get('surface')  == 'rumple')) || (feature.get('surface')  == 'ocean')) || (feature.get('surface')  == 'ice tongue'));
    } else {
        return ((((feature.get('surface')  == 'ice shelf') || (feature.get('surface')  == 'rumple')) || (feature.get('surface')  == 'ocean')) || (feature.get('surface')  == 'ice tongue'));
    }
}
...
function exp_Antarcticbasemap_0rule1_eval_expression(context) {
    // surface = 'land'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('surface')  == 'land');
    } else {
        return (feature.get('surface')  == 'land');
    }
}