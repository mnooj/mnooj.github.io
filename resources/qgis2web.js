...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 12, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3031',
            extent: [-2731476.245198, -2582239.923155, 2886172.333029, 2393799.916707],
            units: 'm'})
    })
});
...
map.getView().fit([-2731476.245198, -2582239.923155, 2886172.333029, 2393799.916707], map.getSize());
