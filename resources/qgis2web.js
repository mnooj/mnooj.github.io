...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3031',
            extent: [-2661585.000000, -2494398.500000, 2748309.250000, 2321809.500000],
            units: 'm'})
    })
});
...
map.getView().fit([-2661585.000000, -2494398.500000, 2748309.250000, 2321809.500000], map.getSize());
