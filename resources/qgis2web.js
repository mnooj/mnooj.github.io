...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 12, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3031',
            extent: [-2661585.000000, -2505086.680847, 2806625.822651, 2424836.956068],
            units: 'm'})
    })
});
...
map.getView().fit([-2661585.000000, -2505086.680847, 2806625.822651, 2424836.956068], map.getSize());
