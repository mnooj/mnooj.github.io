...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 12, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3031',
            extent: [-2734967.269074, -2568055.846282, 2878909.410609, 2473052.748417],
            units: 'm'})
    })
});
...
map.getView().fit([-2734967.269074, -2568055.846282, 2878909.410609, 2473052.748417], map.getSize());
